...
import StudentModel from "../models/Estudiantes.js";

const StudentsrecoveryPasswordController = {};

//Solicitar el código por correo electrónico
StudentsrecoveryPasswordController.requestCode = async (req,res) => {
    try {
        ...
        const token = jsonwebtoken.sign (
            ...
            {email, code, usertype: "Student", verified: false},
            //#2- Secret key
            config.JWT.secret,
            //#3- ¿Cuanto expira? 
            { expiresIn: "15m"},
...
//Verificar el código 
StudentsrecoveryPasswordController.verifyCode= async (req,res) => {
    try {
...
StudentsrecoveryPasswordController.newPassword = async (req,res) => {
    try {
        //#1- Solicitar los datos
